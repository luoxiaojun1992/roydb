...
//        ],
//        'pika' => [
//            'host' => env('REDIS_PIKA_HOST', '127.0.0.1'),
//            'port' => envInt('REDIS_PIKA_PORT', 6379),
//            'timeout' => envDouble('REDIS_PIKA_TIMEOUT', 1),
//            'pool_size' => envInt('REDIS_PIKA_POOL_SIZE', 5),
//            'passwd' => env('REDIS_PIKA_PASSWD', null),
//            'db' => envInt('REDIS_PIKA_DB', 4),
//            'prefix' => env('REDIS_PIKA_PREFIX', 'sw-fw-less:pika:'),
//        ],
    ],
